...
public class Car {
	...
	public Car(World world, float width, float length, Vector2 position,
		...
		super();		
		this.steer = proigo.STEER_NONE;
		this.accelerate = proigo.ACC_NONE;
	...
	public void update (float deltaTime){
        ...
        if((this.accelerate==proigo.ACC_ACCELERATE) && (this.getSpeedKMH() < this.maxSpeed)){
        	baseVector= new Vector2(0, -1);
        }
        else if(this.accelerate==proigo.ACC_BRAKE){
        ...
        else if (this.accelerate==proigo.ACC_NONE ) {
