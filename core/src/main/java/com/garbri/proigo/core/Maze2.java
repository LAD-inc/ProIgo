...
public class Maze2 implements Screen {
private long lastRender;
	...
	private void resetGame()
	{
	    ...
	    this.player1 = new Car("player1", world, 2, 4,
	    		this.maze.playerStartPoint[0], (float) Math.PI/2, 60, 20, 180, controls.get(0), spriteHelper.getCarSprite(2), spriteHelper.getWheelSprite());
